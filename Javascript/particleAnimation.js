$(document).ready(function () {
    ...
    function documentMouseMoveHandler(event) {
        mouseX = event.clientX - ($("#home").width()) * .01;
        mouseY = event.clientY - ($("#home").height()) * .01;
    }
    ...
    function canvasTouchStartHandler(event) {
        if (event.touches.length == 1) {
            ...
            mouseX = event.touches[0].pageX - ($("#home").width()) * .01;
            mouseY = event.touches[0].pageY - ($("#home").height()) * .01;
        }
    }
